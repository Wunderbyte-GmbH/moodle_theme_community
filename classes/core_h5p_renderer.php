...
if (file_exists($CFG->dirroot.'/h5p/classes/output/renderer.php')) {
    if (method_exists(\core_h5p\output\renderer::class, 'h5p_alter_styles')) {
        /**
         * Class theme_community_core_h5p_renderer.
         *
         ...
         * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
         */
        class theme_community_core_h5p_renderer extends \core_h5p\output\renderer {
            use \theme_community\hvp_toolbox;
            ...
            public function h5p_alter_styles(&$styles, $libraries, $embedtype) {
                $this->chvp_alter_styles($styles, $libraries, $embedtype);
            }
        }
    }
}
