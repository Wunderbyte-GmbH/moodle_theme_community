...
function scrollspy_entries(){
    ...
    try {
        ...
        $link = new \moodle_url("/admin/settings.php?section=themesettingmusi#theme_musi_advanced");
        echo sprintf("\nValue 'custom_menu_items' is not XML conform! Please change it at <a href='%s'>%s</a>", $link, $link);
    }
}
